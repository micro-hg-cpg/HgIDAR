...
#' IHg(peaks_1, masses_1, abundances_1, 24, 3, type = 'liquid' , 198, 5)
#' IHg(peaks_2, masses_2, abundances_2, 26, 3, type = 'solid' ,199, 27.27)
IHg=function(x, y, z, samples, injections = 3, type = c('liquid', 'solid'),   quant_IHg, spike_concentration_IHg ){
  type <- match.arg(type)
