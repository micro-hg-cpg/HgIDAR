...
#' MMHg(peaks_1, masses_1, abundances_1, 24, 3, type = 'liquid' , 198, 5)
#' MMHg(peaks_2, masses_2, abundances_2, 26, 3, type = 'solid' ,199, 27.27)
MMHg=function(x, y, z, samples, injections = 3, type = c('liquid', 'solid'),  quant_MMHg, spike_concentration_MMHg ){
  type <- match.arg(type)
