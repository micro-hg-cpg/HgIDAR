#' Abundance table for example 3
#'
#' It contains the isotopic abundance for the analysis.
#' This example contains only isotopes 198 through 202 because those are the ones relevant for this example.
...
#'   \item{ isotope_198, isotope_199, isotope_200, isotope_201, isotope_202}{isotopic composition of each spike and natural}
#' }
