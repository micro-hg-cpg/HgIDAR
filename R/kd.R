...
kd=function(x, y, z, samples, injections = 3, type = c('liquid', 'solid'), incub_IHg,incub_MMHg, quant_MMHg, quant_IHg,nat, spike_concentration_MMHg, spike_concentration_IHg ){
  type <- match.arg(type)
