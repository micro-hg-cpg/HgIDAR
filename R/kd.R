...
#' @param incub_MMHg IHg isotope used for the incubation
...
#'   spike_concentration_MMHg=0.5,
#'   spike_concentration_IHg=5)
kd=function(x, y, z, samples, injections = 3, type = c('liquid', 'solid'), incub_MMHg, quant_MMHg, quant_IHg, spike_concentration_MMHg, spike_concentration_IHg ){
  type <- match.arg(type)
  ...
  p <- w%>%
    ...
    dplyr::mutate("methylation" = (w[,3]/totalconcentration))%>%
