...
The HgIDAR package can be use to calculate Hg concentrations and Hg methylation and demathylation ratios using isotopic dilution approaches. This package is available in CRAN repository and installation can be done with the following command:
...
To explore the functions available in this package, we'll use an mock-up scenario in which we'll have double spiked sediment samples, with isotope 199 enriched inorganic mercury (IHg) and isotope 201 enriched monomethylmercury (MMHg). These incubation spikes will allow us to measure the transformations; by measuring the concentration of 199 MMHg, we can calculate how much MMHg has form during the incubation and thus the potential methylation rate constant. Likewise by measuring the concentration of 201 IHg, we can calculate how much MMHg has undergone demethylation and thus calculate the potencial demethylation rate constant.
...
##Calculate methylation rate constant 
